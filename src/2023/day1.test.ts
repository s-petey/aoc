...
describe('Day 1', () => {
  describe('Part 1', () => {
    test('Example results in 142', () => {
      const { sum } = day1Part1(part1ExampleData);
      expect(sum).toBe(142);
    });

    test('Actual results in 54159', () => {
      const { sum } = day1Part1(day1Part1Data);
      expect(sum).toBe(54159);
    });
  });

  describe('Part 2', () => {
    test('Actual results in 53866', () => {
      const { sum } = day1Part2(day1Part1Data);
      expect(sum).toBe(53866);
    });
  });
});

const part1ExampleData = ['1abc2', 'pqr3stu8vwx', 'a1b2c3d4e5f', 'treb7uchet'];
